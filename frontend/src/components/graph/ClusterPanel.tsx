...
const ClusterPanel: React.FC<ClusterPanelProps> = ({
  ...
  return (
    <Card className={clsx('overflow-hidden py-0', className)}>
      ...
      {/* Cluster list */}
      {!collapsed && (
        <div id="cluster-panel-list" className="flex max-h-80 flex-col gap-1 overflow-y-auto p-2">
      ...
      {!collapsed && hasSelectedClusters && (
        <div className="px-4 py-2 border-t border-border-light bg-bg-sidebar/50 dark:border-dark-border dark:bg-dark-bg-sidebar/60">
          <div className="flex items-center justify-between">
            ...
            <Button type="button" variant="link" className="h-auto p-0 text-xs" onClick={clearClusterFilter}>
              {t('common.show_all')}
            </Button>
          </div>
        </div>
