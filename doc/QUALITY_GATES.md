...
1. `/settings` 登录、退出、CSRF 保护正常
2. `incremental` 同步能启动并完成
3. `full refresh` 能启动并正确展示阶段进度
4. Dashboard 能正常展示 summary / top clusters / activity
5. Data 页搜索、cluster filter、分页正常
6. Graph 页搜索、cluster filter、timeline、详情侧栏正常
7. Command Palette 的搜索结果和 Graph/Data 字面搜索语义一致
